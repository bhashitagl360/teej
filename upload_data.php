<?php
	...
	//$totalBytesToUpload = 536870912; // 2gb
  $totalBytesToUpload = 2048; // 2gb

    $match = array("image/png","image/jpg","image/jpeg","video/mp4");
	$visitor_msg = strip_tags( stripslashes($_POST['visitor_msg'] ) );
    $errors = array();
    $data = array();
    ...
    */
    if ( trim( strip_tags( stripslashes($_POST['vistior_name'] ) ) ) == '' ) {
    ...
    ///////////////////-----------------//////////////////////
    print '<pre>';print_r($_FILES);die('test');
