		...
		<div class="row">
			<div class="col-xs-12">
				<div class="innr_contentbox">
					<h1><img src="<?php echo siteUrl; ?>/images/heading.png" alt="" /></h1>
				...
				<div class="row mobilerow">
					...
					<div class="col-sm-4 no_padding">
						<div class="detailbox detailbox_<?php echo $slug; ?>">
							<img src="<?php echo siteUrl.'/'.$front_image; ?>" alt="<?php echo str_replace('_', ' ', strtoupper( $slug ) ); ?>" />
							...
							<a href="javascript:void(0);" data-toggle="modal" onclick="menu( '<?php echo base64_encode( $slug ); ?>' );">
								<img src="<?php echo siteUrl; ?>/images/more_<?php echo $slug; ?>.png" alt="" />
							</a>
						</div>
					</div>
